...
function scoreLead(fields) {
	...
	if (fields.preapproved && /yes|pre-?approved/i.test(fields.preapproved)) score += 12;
	if (fields.stage === "appointment") score += 18;
	return Math.min(100, score);
}
function inferStage(fields, hasAppointment) {
	if (fields.stage === "closed" || fields.stage === "archived") return fields.stage;
...
//#endregion
export { inferStage as n, scoreLead as r, getSql as t };
